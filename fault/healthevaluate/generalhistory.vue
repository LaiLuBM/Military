      ...
      <el-col :span="24">
        <el-card>
          <el-row>
            ...
            <el-col :span="20">
              <h2 class="title-margin">通用化装备历史健康评估</h2>
            </el-col>
          </el-row>
            ...
            <el-table-column label="操作" class-name="operation-column shadow-label" align="center" width="250" :show-overflow-tooltip="true">
              <template #default="scope">
                ...
                <span v-if="scope.row.result.suggestionGeneratedStatus === '未生成'">
                  <el-button type="primary" text @click="generateHealthSuggestion(scope.row.result.assessmentId)">
                    生成健康建议
                  </el-button>
                </span>
              </template>
...
const handleEquipInfo = (equipCode: string, approvalStatus: string, assessmentId: string) => {
  // addTab("通用化健康评估结果详情", "/healthevaluate/generaldetail", "Warning");
  // setCurrentTab("通用化健康评估结果详情", "/healthevaluate/generaldetail");
