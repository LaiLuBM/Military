...
import TotalDataContent from '@/views/fault/analyse/placeana/TotalDataContent.vue'
import TimeCountContent from '@/views/fault/analyse/placeana/TimeCountContent.vue'
import PredictTrendContent from '@/views/fault/analyse/placeana/PredictTrendContent.vue'
import SystemTrendContent from '@/views/fault/analyse/placeana/SystemTrendContent.vue'
import PartRatioContent from '@/views/fault/analyse/placeana/PartRatioContent.vue'
import OccurCauseContent from '@/views/fault/analyse/placeana/OccurCauseContent.vue'
import OccurTrendContent from '@/views/fault/analyse/placeana/OccurTrendContent.vue'
