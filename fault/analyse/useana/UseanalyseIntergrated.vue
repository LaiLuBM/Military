...
import TotalDataContent from '@/views/fault/analyse/useana/TotalDataContent.vue'
import TimeCountContent from '@/views/fault/analyse/useana/TimeCountContent.vue'
import PredictTrendContent from '@/views/fault/analyse/useana/PredictTrendContent.vue'
import SystemTrendContent from '@/views/fault/analyse/useana/SystemTrendContent.vue'
import PartRatioContent from '@/views/fault/analyse/useana/PartRatioContent.vue'
import OccurCauseContent from '@/views/fault/analyse/useana/OccurCauseContent.vue'
import OccurTrendContent from '@/views/fault/analyse/useana/OccurTrendContent.vue'
