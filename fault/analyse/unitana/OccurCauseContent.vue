...
import { malfunitreason } from '@/api/fault/unitanalyse';
...
const handleQuery = async () => {
  const params = {
    ...
    unitList: selectedCompareUnits.value.join(','), // Use selectedUnitPaths instead of region
  };
  ...
  const response = await malfunitreason(params); // Use correct API
