...
import TotalDataContent from '@/views/fault/analyse/unitana/TotalDataContent.vue'
import TimeCountContent from '@/views/fault/analyse/unitana/TimeCountContent.vue'
import PredictTrendContent from '@/views/fault/analyse/unitana/PredictTrendContent.vue'
import SystemTrendContent from '@/views/fault/analyse/unitana/SystemTrendContent.vue'
import PartRatioContent from '@/views/fault/analyse/unitana/PartRatioContent.vue'
import OccurCauseContent from '@/views/fault/analyse/unitana/OccurCauseContent.vue'
import OccurTrendContent from '@/views/fault/analyse/unitana/OccurTrendContent.vue'
