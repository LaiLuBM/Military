        ...
        <el-col :span="4">
            <div>
                <el-button style="width: 100%; height: 105px; font-size: 18px; margin-bottom: 5px;"
                    :class="{ active: activeTab === 'total-data' }" @click="activeTab = 'total-data'">
                    故障预测数据总量
                </el-button>
            </div>
            <div>
                <el-button style="width: 100%; height: 105px; font-size: 18px; margin-bottom: 5px;"
                    :class="{ active: activeTab === 'time-count' }" @click="activeTab = 'time-count'">
                    故障发生时间数量
                </el-button>
            </div>
            <div>
                <el-button style="width: 100%; height: 105px; font-size: 18px; margin-bottom: 5px;"
                    :class="{ active: activeTab === 'predict-trend' }" @click="activeTab = 'predict-trend'">
                    故障概率发生趋势
                </el-button>
            </div>
            <div>
                <el-button style="width: 100%; height: 105px; font-size: 18px; margin-bottom: 5px;"
                    :class="{ active: activeTab === 'system-trend' }" @click="activeTab = 'system-trend'">
                    故障发生分系统趋势
                </el-button>
            </div>
            <div>
                <el-button style="width: 100%; height: 105px; font-size: 18px; margin-bottom: 5px;"
                    :class="{ active: activeTab === 'part-ratio' }" @click="activeTab = 'part-ratio'">
                    故障发生部件比例
                </el-button>
            </div>
            <div>
                <el-button style="width: 100%; height: 105px; font-size: 18px; margin-bottom: 5px;"
                    :class="{ active: activeTab === 'occur-cause' }" @click="activeTab = 'occur-cause'">
                    故障发生原因
                </el-button>
            </div>
            <div>
                <el-button style="width: 100%; height: 105px; font-size: 18px; margin-bottom: 5px;"
                    :class="{ active: activeTab === 'occur-trend' }" @click="activeTab = 'occur-trend'">
                    故障发生趋势
                </el-button>
            </div>
        </el-col>
...
import TotalDataContent from '@/views/fault/analyse/repairana/TotalDataContent.vue'
import TimeCountContent from '@/views/fault/analyse/repairana/TimeCountContent.vue'
import PredictTrendContent from '@/views/fault/analyse/repairana/PredictTrendContent.vue'
import SystemTrendContent from '@/views/fault/analyse/repairana/SystemTrendContent.vue'
import PartRatioContent from '@/views/fault/analyse/repairana/PartRatioContent.vue'
import OccurCauseContent from '@/views/fault/analyse/repairana/OccurCauseContent.vue'
import OccurTrendContent from '@/views/fault/analyse/repairana/OccurTrendContent.vue'
